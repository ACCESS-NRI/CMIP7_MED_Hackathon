...
- "Why access live-cmoriser?"
- "Which variables are support by access live-cmoriser"
- "How to use it on GADI"

objectives:

- "Understand what is live-cmoriser"
- "Know how to use live-cmoriser on GADI"
- "Run a example recipe"

keypoints:
- "Live (or on-the-fly) CMORiser acts as an intermediary, modifying only the necessary data for comparison so ESMValTool sees it as CMORised."
- "On suport some variable in ACCESS-ESM1.5"
- "The ESMValTool with access live-cmoriser was located in `xp65`"
- "Modify `config-developer.yml` for personalized requirement"
---
